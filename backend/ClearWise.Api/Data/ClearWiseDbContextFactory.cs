...
/// </summary>
/// <remarks>
/// Migrations connect as <c>clearwise_owner</c>, not as the application role. The
...
/// </remarks>
public sealed class ClearWiseDbContextFactory : IDesignTimeDbContextFactory<ClearWiseDbContext>
{
    public ClearWiseDbContext CreateDbContext(string[] args)
    {
        var configuration = new ConfigurationBuilder()
            .SetBasePath(Directory.GetCurrentDirectory())
            .AddJsonFile("appsettings.json", optional: true)
            .AddJsonFile("appsettings.Development.json", optional: true)
            .AddUserSecrets<ClearWiseDbContextFactory>(optional: true)
        ...
        var options = new DbContextOptionsBuilder<ClearWiseDbContext>()
            .UseNpgsql(connectionString)
            .UseSnakeCaseNamingConvention()
            .Options;

        return new ClearWiseDbContext(options);
    }
}
