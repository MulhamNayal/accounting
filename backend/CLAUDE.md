...
**If you have also worked in Mulham's other ERP codebase:** four rules here are the
*opposite* of that one's — lazy loading, EF migrations, the repository layer, and error
handling. Don't carry those habits over.
