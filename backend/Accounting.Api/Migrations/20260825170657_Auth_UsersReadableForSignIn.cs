...
namespace Accounting.Api.Migrations
{
    ...
    /// <para>
    /// Dropping FORCE leaves the policy fully in effect for <c>accounting_app</c> — the role
    /// the application actually uses — while allowing the owner-owned function to resolve one
