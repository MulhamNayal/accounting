...
namespace Accounting.Api.Migrations
{
    ...
    /// <para>
    /// Dropping FORCE leaves the policy fully in effect for <c>accounting_app</c> Ã¢â‚¬â€ the role
    /// the application actually uses Ã¢â‚¬â€ while allowing the owner-owned function to resolve one
