...
public static class TestDatabase
{
    ...
    /// </summary>
    public static ClearWiseDbContext CreateOwnerContext() =>
        new(new DbContextOptionsBuilder<ClearWiseDbContext>()
    ...
    /// </summary>
    public static ClearWiseDbContext CreateAppContext(ITenantContext tenantContext) =>
        new(new DbContextOptionsBuilder<ClearWiseDbContext>()
